          ...
          <div id="coletaNome">
            ...
            <div id="question-1"style="display:none">
              ...
              <img src="imagens/1.png" alt="some text" width="300" ><br>
  	  			  <h3>Coloque em ordem que completa os desendos!</h3>
  	  			  <div>
              ...
              <source src="video/felicidade.mp4" type="video/mp4"><br>
  				  ...
  				  <h3>Assinale qual opção representa o sentimento em que o video mostra: </h3>
            ...
            <div id="question-4"style="display:none">
              <h2>Questão 4</h2>
              <h3>O aplicativo tem a fução de escolher a cor da tela, quais dessas imagens faz essa função?</h3>
            ...
            <div id="question-5"style="display:none">
              ...
              <h3>Quando dar a soma de Gatos e Porquindos?</h3>
            ...
            <div id="question-6" style="display:none">
              ...
              <source src="video/a arvore sem folhas.mp4" type="video/mp4"><br>
  				    ...
  				    <h3>Na Historia quem colocou coraçoes na arvore</h3>
            ...
            <div id="question-7" style="display:none">
  				    ...
  				    <h3>Ultilize a ferramenta de Ler texto e mostre o caminho onde a encontrou</h3>
              <div>
              <input type="radio" name="q7" value='e'> 
              <img src="imagens/introd.jpg" alt="some text" height=60>
              <img src="imagens/quest.jpg" alt="some text" height=60>
              <img src="imagens/ler t.jpg" alt="some text" height=60>
  				    </div><br>

              <div>
              <input type="radio" name="q7" value='e'> 
              <img src="imagens/quest.jpg" alt="some text" height=60>
              <img src="imagens/video.jpg" alt="some text" height=60>
              <img src="imagens/ler t.jpg" alt="some text" height=60>
              </div><br>

  				    <div>
              <input type="radio" name="q7" value='c'> 
              <img src="imagens/textoaud.jpg" alt="some text" height=60>
              <img src="imagens/port.jpg" alt="some text" height=60>
              <img src="imagens/ler t.jpg" alt="some text" height=60> 
              </div><br>

              <div>
              <input type="radio" name="q7" value='e'> 
              <img src="imagens/mat.jpg" alt="some text" height=60>
              <img src="imagens/ler t.jpg" alt="some text" height=60>
              <img src="imagens/port.jpg" alt="some text" height=60> 
  				    </div><br>
            ...
            <div id="question-8" style="display:none">
              ...
              <h3>Qual Letra da forca esta faltando?</h3>
              <input type="radio" name="q8" value="e"> L<br>
              <input type="radio" name="q8" value="e"> T<br>
              <input type="radio" name="q8" value="e"> F<br>
              <input type="radio" name="q8" value="c"> I<br>
              <input type="radio" name="q8" value="e"> P<br>
            ...
            <div id="question-9" style="display:none">
              <h2>Questão 9</h2>
              <h3>Carol quer uma pizza, mas consegue uma carne hambúrguer. Como se sente Carol?</h3>
            ...
            <div id="question-10" style="display:none">
              ...
              <h3>Qual a quantidade de quadrado a figura acima?</h3>
